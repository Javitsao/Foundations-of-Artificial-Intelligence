...
def main():
    ...
    # # Plot reconstructed image using PCA
    # img_path = './data/subject_05_17.png'
    # img = Image.open(img_path).convert("L")
    # img_array = np.array(img)
    # img_reconstruct_pca = pca.reconstruct(img_array.flatten())
    # plt.subplot(2, 2, 1)
    # plt.imshow(img_array, cmap='gray')
    # plt.title('Original Image')
    # plt.subplot(2, 2, 2)
    # plt.imshow(img_reconstruct_pca.reshape(img_array.shape), cmap='gray')
    # plt.title('Reconstructed Image (PCA)')
    # plt.subplot(2, 2, 3)
    # plt.imshow(img_reconstruct_ae.reshape(img_array.shape), cmap='gray')
    # plt.title('Reconstructed Image (Autoencoder)')
    # plt.subplot(2, 2, 4)
    # plt.imshow(img_reconstruct_deno_ae.reshape(img_array.shape), cmap='gray')
    # plt.title('Reconstructed Image (Denoising Autoencoder)')
    # plt.tight_layout()
    # plt.show()
